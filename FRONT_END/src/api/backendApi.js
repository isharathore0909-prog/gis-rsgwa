...
class BackendAPIClient {
    ...
    async getRainfallStatistics(params = {}) {
        return this.get(BACKEND_API.ENDPOINTS.RAINFALL_STATISTICS, params, true);
    }

    async getRainfallSummary(params = {}) {
    ...
    async getWaterQualityStatistics(params = {}) {
